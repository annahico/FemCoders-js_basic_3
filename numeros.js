...
let resto = (a, b) => a / b;
console.log(resto(45, 7));

// Escribe una función que tome un número como argumento y devuelva su raíz cuadrada.
let raizCuadrada  = (num) => Math.sqrt(num); //es una función incorporada en JavaScript que calcula la raíz cuadrada de un número.
